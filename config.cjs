...
const config = {
  SESSION_ID: process.env.SESSION_ID || "PRINCE~JUNIOR~V2~DJQkVTgY#38lYBnPSLyclloJ5xYqwEhNqLif8n_99HIQdoMgmxn4",
  ...
  OWNER_NUMBER: process.env.OWNER_NUMBER || "254723245807",
